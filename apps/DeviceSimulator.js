...
/*
 * GpsAisSimulator simulate a GPS. It takes input from gpx route/track file.
 * It support OpenCPN/VisuGPX export format, and hopefully while not tested
 * many other GPX format may work.
 * 
 * GpsAisSimulator can either send its NMEA feed as a client, or server to consumer.
...
// Import debug method 
ParseArgs.prototype.Debug = Debug;
    ...
    if (! parsing.opts.help) {
        simu= new GpsdSimulator (parsing.opts);
    }
