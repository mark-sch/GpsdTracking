...
AisEncode = function (msg) {
    this.payload = new Buffer(256); // make a buffer force it 6bit/zero 
    ...
    switch (msg.msgtype) {
        ...
        case 3: // class A position report
            ...
            hdg=parseInt (msg.hdg);      //magnetic heading 
            this.PutInt (hdg,  128, 9 );
            
            this.PutInt  (60,  137, 6 );  // 60 if time stamp is not available
                                  
            // console.log ('cog=%s, hdg, utc=%s', this.cog, this.hdg, this.utc);
            break;
        case 18: // class B position report
            ...
            this.PutInt  (60,  133, 6 );  // 60 if time stamp is not available
...
//          2-3 = station compliant with future editions
            ...
            this.PutInt(draught, 294, 8);
            this.PutStr(msg.destination302, 120);
