...
DevAdapter = function(controler) {
    ...
    this.uid       = "adapter:TK103/GPS103//" +  controler.svcopts.port;;
    ...
    "bnf": { // WARNING: only one space in between TOKEN ex: "STOP EOF"
        ...
        , 'GPSDATA' : [ // F,215931.000,A,4737.1058,N,00245.6524,W,0.00,0  [multiple end option W,0.00,0; | W,0.00,; | W,0.00;]
                ["FULL FLOATSEP ALL FLOATSEP CARDINAL FLOATSEP CARDINAL FLOATSEP FLOAT END"
                      ,"this.valid=true;this.alt=parseFloat($9); this.lat=[parseFloat($4), $5]; this.lon=[parseFloat($6), $7]; this.sog=parseFloat($8); this.cog=parseFloat($9);"],
                ["FULL FLOATSEP ALL FLOATSEP CARDINAL FLOATSEP CARDINAL FLOATSEP INT END"
                      ,"this.valid=true;this.alt=parseFloat($9); this.lat=[parseFloat($4), $5]; this.lon=[parseFloat($6), $7]; this.sog=parseFloat($8); this.cog=parseInt($9);"],
                ["FULL FLOATSEP ALL FLOATSEP CARDINAL FLOATSEP CARDINAL FLOATSEP END"
                      ,"this.valid=true;this.alt=parseFloat(0.0); this.lat=[parseFloat($4), $5]; this.lon=[parseFloat($6), $7]; this.sog=parseFloat($8);"],
