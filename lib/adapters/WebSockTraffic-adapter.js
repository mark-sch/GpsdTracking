...
var Device      = require('../GpsdTcpClient'); // in this cas a device is a feed
var net         = require('net');
var url         = require("url"); 
...
DevAdapter = function(controler) {
    this.uid       = "adapter:" + "websock//"  + controler.svcopts.port;
    this.info      = 'websock';
    ...
    HookBackendEvent(this, controler.gpsd.backend);
};
