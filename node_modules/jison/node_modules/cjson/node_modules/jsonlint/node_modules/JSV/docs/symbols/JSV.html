				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the utility methods documented in the class JSV.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">JSV.<b><a href="../symbols/JSV.html#.event:randomuid">randomuid</a></b>()
								</div>
								<div class="description">Generates a pseudo-random uid.</div>
							</td>
						</tr>
...
<!-- ============================== event details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".event:randomuid"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">JSV.</span><b>randomuid</b>()
